...
namespace Business_Logic_Layer.Services
{
    public class MaterialManufacturerServices : IMaterialManufacturerServices
    {
        ...
        {
            MaterialManufacturer materialManufacturerEntity = GenericAutoMapper<MaterialManufacturerModel, MaterialManufacturer>.Map(materialManufacturer);
        ...
        public IEnumerable<MaterialManufacturerModel> GetAllMaterialManufacturers()
        {
            ...
            IEnumerable<MaterialManufacturerModel> materialManufacturersModel = GenericAutoMapper<MaterialManufacturer,MaterialManufacturerModel>.MapEnumerable(materialManufacturers);
        ...
        public MaterialManufacturerModel GetMaterialManufacturerById(int id)
        {
            ...
            MaterialManufacturerModel materialManufacturerModel = GenericAutoMapper<MaterialManufacturer, MaterialManufacturerModel>.Map(materialManufacturer);
