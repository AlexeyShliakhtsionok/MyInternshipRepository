...
// Test evaluation
let intermediate = filterImpementation(
	arrayToFindEvenNumbersAverage,
	callbackFilterFunction,
);
console.log("Filtered array: " + intermediate);

let averageResult = linearFold(
	filterImpementation(arrayToFindEvenNumbersAverage, callbackFilterFunction),
	callbackSumPrevWithCurr,
	0,
);
