...
function firstInArray(array, callbackFunct, condition) {
  ...
  if (index === 0) {
    return console.log("There are no values in the array that satisfy the condition");
  }
  return console.log(`The value that satisfy the condition is in the array at index ${index}`);
};
...
const conditionForArrayElement_2 = x => !Number.isInteger(x);
const conditionForArrayElement_3 = x => typeof(x) === "function";

let arr = ["asd","b","c", 4, 5, 6, function(x){return x*2}];
